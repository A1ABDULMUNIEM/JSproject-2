      ...
      .then((data) => {
        ...
        products.forEach((product) => {
          ...
          productElement.style =
            "display: inline-block; width: 30%; margin: 10px; padding: 10px; border: 1px solid #ccc;";
    ...
    fetch(this.apiURL + "products/" + id)
      ...
      .then((data) => {
        document.querySelector(
          ".product_image"
        ).innerHTML = `<img src="${data.images[0]}" class="img-fluid" alt="${data.title}">`;
        ...
        document
          ...
          .addEventListener("click", () => this.addToCart(data));
      });
  }
